...
import 'package:standard/films/data/repository/films_repository.dart' as _i9;
...
_i1.GetIt init(
  ...
  gh.singleton<_i8.FetchPeopleCubit>(
      _i8.FetchPeopleCubit(peopleRepo: gh<_i6.PeopleRepo>()));
  gh.singleton<_i9.FilmsRepo>(_i10.FilmsRepoImpl(gh<_i5.FilmsSource>()));
  gh.singleton<_i11.FetchFilmsCubit>(
      _i11.FetchFilmsCubit(filmsRepo: gh<_i9.FilmsRepo>()));
  return getIt;
}
